...
class Testtitle(unittest.TestCase):   #Normally write tests on separate file.
    def test_Dup_Nums(self):
        self.assertEqual(DupNums([1,2,3,'4','5']), [])
        self.assertEqual(DupNums(['a','b','c',1,2,'b','b']), [])
        self.assertEqual(DupNums(['a','b','3','c',1,2,1,1,'3']),['3','1'])

    	self.assertEqual(DupNums(['a',1,2,1,'c',1,2,'d','d','3','3','3',1,3,'a',5,'a','b']),['1','2','3'])

if __name__ =='__main__':
    print DupNums(['a',1,2,1,'c',1,2,'d','d','3','3','3',1,3,'a',5,'a','b'])
    unittest.main()
